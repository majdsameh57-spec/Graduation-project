...
@section('title', 'سيولتك - تعديل منتج')
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="shop_id" id="shop_id" class="form-select" required>
                                        ...
                                        @foreach ($shops as $shop)
                                            <option value="{{ $shop->id }}" {{ in_array($shop->id, $product->shops->pluck('id')->toArray()) ? 'selected' : '' }}>
                                                {{ $shop->name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="name" class="form-control" value="{{ old('name') ?? $product->name }}" placeholder="أدخل اسم المنتج" required>
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="price" step="0.01" value="{{ old('price') ?? $product->price }}" class="form-control" placeholder="أدخل سعر المنتج" required>
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="description" class="form-control" rows="3" placeholder="وصف تفصيلي للمنتج (اختياري)">{{ old('description') ?? $product->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="product-image-preview mt-2">
                                    ...
                                    <div class="text-muted small mt-1">الصورة الحالية</div>
                                </div>
                                @endif
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const selectedBranches = @json($product->branches->pluck('id')->toArray());
                ...
                reader.onload = function(e) {
                    previewContainer.innerHTML = `
                        <div class="product-image-preview mt-2">
                            ...
                            <div class="text-muted small mt-1">الصورة الجديدة</div>
                        </div>
                    `;
                };
