...
@section('title', 'تسجيل الدخول للتاجر - سيولتك')
@section('styles')
    <style>
        .login-section {
            padding: 4rem 0;
        ...
        <div class="container">
            <div class="login-card">
                <div class="login-type-tabs">
                    <a href="{{ route('show-login') }}" class="login-type-tab active">تسجيل دخول كتاجر</a>
                    <a href="{{ route('user.login') }}" class="login-type-tab">تسجيل دخول كمستخدم</a>
                </div>
                ...
                <form action="{{route('login')}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            <input type="email" name="email" class="form-control" id="email"
                                   placeholder="مثال: merchant@email.com" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            <input type="password" name="password" class="form-control" id="password"
                                   placeholder="مثال: 12345678" required>
                            <div class="input-icon">
                    ...
                    <div class="login-links">
                        ...
                        <p>لا تملك حساباً؟<a href="{{ route('merchant.register') }}" class="login-link">سجل حساب جديد</a></p>
                    </div>
                </form>
            </div>
        </div>
