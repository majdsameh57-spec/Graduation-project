...
@section('title', 'إنشاء حساب تاجر جديد - سيولتك')
@section('styles')
    <style>
        .register-section {
            padding: 4rem 0;
        ...
        <div class="container">
            <div class="register-card">
                <div class="register-type-tabs">
                    <a href="{{ route('merchant.register') }}" class="register-type-tab active">تسجيل كتاجر</a>
                    <a href="{{ route('user.register') }}" class="register-type-tab">تسجيل كمستخدم</a>
                </div>
                ...
                <form action="{{ route('merchant.register.submit') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            <input type="text" name="mobile" class="form-control" id="mobile"
                                   placeholder="مثال: 05xxxxxxxx" required value="{{ old('mobile') }}">
                            <div class="input-icon">
                    ...
                    <div class="register-links">
                        <p>لديك حساب بالفعل؟ <a href="{{ route('show-login') }}" class="register-link">سجل دخول</a></p>
                    </div>
                </form>
            </div>
        </div>
